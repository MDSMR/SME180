 ...
 *   /home/customer/www/mohamedk10.sg-host.com/public_html/create_pos_files.php
 */

declare(strict_types=1);

$basePath = __DIR__; // root = public_html
...
echo "<strong>Created files:</strong><br>" . implode("<br>", $created) . "<br><br>";
echo "<strong>Already existing (skipped):</strong><br>" . implode("<br>", $existing) . "<br>";
