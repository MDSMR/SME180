...
/**
 * New Modifier Value
 * Path: /public_html/views/admin/catalog/modifier_value_new.php
 * - Requires group_id
...
<head>
  <meta charset="utf-8">
  <title>New Value · <?= h((string)$group['name']) ?> · Smorll POS</title>
...
<div class="page-container">
  ...
  <div class="breadcrumb">
    ...
    <span class="breadcrumb-separator">/</span>
    <span class="breadcrumb-current">New Value</span>
  </div>

  <!-- Page Header -->
  <div class="page-header">
    <h1 class="page-title">New Value</h1>
    <p class="page-subtitle">Add a new option to <?= h((string)$group['name']) ?> modifier</p>
  </div>
      ...
      <div class="form-grid">
        <div class="form-group">
          ...
          <input type="number" name="price_delta" class="form-input" 
                 value="0.00" step="0.01" placeholder="0.00">
